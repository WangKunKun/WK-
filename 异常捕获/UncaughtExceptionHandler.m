...
- (void)handleException:(NSException *)exception
{
    ...
    UIAlertView *alert = [[[UIAlertView alloc]initWithTitle:@"程序错误" message:@"程序因为某种原因发生了错误，我们已经记录下此次崩溃的原因，会尽快解决问题，很抱歉给您带来的不便。" delegate:self cancelButtonTitle:@"确认" otherButtonTitles:nil, nil]autorelease];
    [alert show];
